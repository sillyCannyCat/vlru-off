<template>
  <div class="p-8 inline-flex flex-col gap-[16px]">
  ...
  <Label>12.12</Label>
  <Label variant="ghost">12.12</Label>
  <StatsLabel :value="-12"></StatsLabel>
  <StatsLabel :value="12"></StatsLabel>
  <Input
    label="Заголовок"
    placeholder="Пример текста"
    prefixIcon="/icons/hot-water.svg"
  ></Input>
  <Input
    label="Заголовок"
    placeholder="Пример текста"
    suffixIcon="/icons/hot-water.svg"
  ></Input>
